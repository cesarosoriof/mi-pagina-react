      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <p className="hero-sub">
            ...
            <br />
            entregados con amor a quien más quieres.
          </p>
          <div className="hero-cta">
            <button
              className="btn-primary"
              onClick={() => navigate({ page: "catalog", category: "detalles-sorpresa" })}
            >
              Ver Detalles Sorpresa
            </button>
            <button
              className="btn-outline"
              onClick={() => navigate({ page: "catalog", category: "arreglos-florales" })}
            >
              Arreglos Florales
            </button>
            <button
              className="btn-two"
              onClick={() => navigate({ page: "catalog", category: "fresas-con-chocolate" })}
            >
